...
export default function ProjectPage() {
    ...
    return (
        <div className="min-h-screen bg-[#F1F1F1] dark:bg-gray-800 py-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <section className='flex flex-col gap-4  md:justify-between'>
                            {/* My Contribution */}
                            <section className="bg-white rounded-2xl shadow-sm p-6 md:justify-start lg:justify-start dark:bg-gray-900">
                                <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">
                                    My Contribution
                                </h2>
                                <ul className="space-y-2">
                                    {project.contributions.map((contribution, index) => (
                                        <li key={index} className="flex items-start">
                                            ...
                                            <span className="text-gray-600 dark:text-gray-200">{contribution}</span>
                                        </li>
                                    ))}
                                </ul>
                            </section>
                            ...
                            {/* All Contributors */}
                            <section className="bg-white rounded-2xl shadow-sm p-6 md:justify-end lg:justify-end dark:bg-gray-900">
                                <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">
                                    All Contributors
                                </h2>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex flex-col space-y-2">
                                    <Link
                                        ...
                                        className="flex items-center px-4 py-2 rounded-lg transition-colors duration-200 bg-gray-400 hover:bg-gray-500 text-white"
                                    >
