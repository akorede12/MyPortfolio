...
export default function Navbar() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-2 md:py-2 bg-white dark:bg-gray-800">
      <div className="flex md:flex-row justify-between items-center">
        ...
        <div className="space-x-8 hidden md:block">
          ...
          <Link href="/projects" className={`text-base  ${pathname === "/projects"
            ? "text-gray-800 font-bold dark:text-gray-400"
            : "text-gray-600 dark:text-gray-300 font-normal "
            }`}>
            Projects
          ...
          <Link href="/experience" className={`text-base  ${pathname === "/experience"
            ? "text-gray-800 font-bold dark:text-gray-400"
            : "text-gray-600 dark:text-gray-300 font-normal "
            }`}>
            Experience{" "}
          ...
          <Link href="/contact" className={`text-base  ${pathname === "/contact"
            ? "text-gray-800 font-bold dark:text-gray-400"
            : "text-gray-600 dark:text-gray-300 font-normal "
            }`}>
            Contact
