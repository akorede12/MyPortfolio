const userData = {
  ...
  designation: "Blockchain Developer, Frontend Engineer, AI Engineer",
  avatarUrl: "/Me2.jpg",
  ...
  about: {
    title: "I'm a Lagos-born software developer with a passion for Frontend Engineering, Blockchain technology, and Artificial Intelligence. \
      With over 4 years of experience building responsive web applications and secure smart contracts, I specialize in creating Web2 and Web3 solutions that are scalable, user-focused, and secure.",
    description: [
      "I’m fascinated by how technology can solve real-world problems and improve everyday life. \
      My journey has taken me from building decentralized applications and cross-chain platforms to teaching web development and leading development teams. \
      I’m driven by a vision of African Excellence powered by technology — especially through advancements in Blockchain and AI.",
    ],
  ...
  experience: [
    {
      title: "Lead Blockchain Developer (Staking & DeFi Ecosystem)",
      company: "CELVIOS - Currrent position",
      year: "February 2025",
      companyLink: "",
      desc: ` 
      Built The Open Protocol decentralized airdrop program on the solana blockchain using rust and anchor, for maximum transaction speed and cheap transaction fees for users, 
      to foster large user base adoption.
      Built a Staking Platform on BNB Smart Chain (BSC) with gamified features to drive token retention and engagement:
